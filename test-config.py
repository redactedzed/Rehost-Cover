...
c_site_collage_ajax_page = "https://redacted.ch/ajax.php?action=addtocollage&collageid=31445" # missing cover art collage ajax page
...
c_site_ajax_page = "https://redacted.ch/ajax.php?action=groupedit&id=" # set the gazelle ajax page here
c_site_collage_ajax_page = "https://redacted.ch/ajax.php?action=addtocollage&collageid=31445" # missing cover art collage ajax page
c_r_api_key = "d64bq2l9.t256n539742x33120h9s5623h3615471" # set your RED api key here
c_p_api_key = "g56643k-35h7-3d1d-5sf5-69h22562q992" # set your ptpIMG api key here
'''
